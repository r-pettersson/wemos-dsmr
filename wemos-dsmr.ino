...
const Measurement measurements[] = {
  /*  {"version", "1-3:0.2.8", 10, 12, false, Measurement::STRING},
    {"version2", "1-0:2.8.0", 10, 12, false, Measurement::STRING},
    {"power/timestamp", "0-0:1.0.0", 10, 23, false, Measurement::STRING},  //roger_ok
    {"power/device_id", "0-0:96.1.1", 11, 45, false, Measurement::STRING}, //roger_not_ok
    ...
    {"power/cumulativeActiveImport", "1-0:1.8.0", 10, 21, false, Measurement::FLOAT}, //kWh
    {"power/cumulativeActiveExport", "1-0:2.8.0", 10, 21, false, Measurement::FLOAT}, //kWh
    {"power/cumulativeReactiveImport", "1-0:3.8.0", 10, 20, false, Measurement::FLOAT},
    {"power/cumulativeReactiveExport", "1-0:4.8.0", 10, 20, false, Measurement::FLOAT},
    {"power/momentaryActiveImport", "1-0:1.7.0", 10, 20, false, Measurement::FLOAT},
    {"power/momentaryActiveExport", "1-0:2.7.0", 10, 20, false, Measurement::FLOAT},
    {"power/momentaryReactiveImport", "1-0:3.7.0", 10, 20, false, Measurement::FLOAT},
    {"power/momentaryReactiveExport", "1-0:4.7.0", 10, 20, false, Measurement::FLOAT},
    {"power/momentaryActiveImportL1", "1-0:21.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryActiveExportL1", "1-0:22.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryActiveImportL2", "1-0:41.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryActiveExportL2", "1-0:42.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryActiveImportL3", "1-0:61.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryActiveExportL3", "1-0:62.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryReactiveImportL1", "1-0:23.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryReactiveExportL1", "1-0:24.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryReactiveImportL2", "1-0:43.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryReactiveExportL2", "1-0:44.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryReactiveImportL3", "1-0:63.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/momentaryReactiveExportL3", "1-0:64.7.0", 11, 20, false, Measurement::FLOAT},
    {"power/voltageL1", "1-0:32.7.0", 11, 20, false, Measurement::FLOAT}, //V
    {"power/voltageL2", "1-0:52.7.0", 11, 20, false, Measurement::FLOAT}, //V
    {"power/voltageL3", "1-0:72.7.0", 11, 20, false, Measurement::FLOAT}, //V
    {"power/currentL1", "1-0:31.7.0", 11, 20, false, Measurement::FLOAT}, //A
    {"power/currentL2", "1-0:51.7.0", 11, 20, false, Measurement::FLOAT},  //A
    {"power/currentL3", "1-0:71.7.0", 11, 20, false, Measurement::FLOAT}};  //A
    //roger
